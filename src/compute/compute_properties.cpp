...
specfem::compute::properties::properties(
  ...
  acoustic_isotropic = specfem::medium::properties_container<
      specfem::element::medium_tag::acoustic,
      specfem::element::property_tag::isotropic>(
      acoustic_elements, mapping, ngllz, ngllx, materials, has_gll_model,
      h_property_index_mapping);

  elastic_isotropic = specfem::medium::properties_container<
      specfem::element::medium_tag::elastic,
      specfem::element::property_tag::isotropic>(
      elastic_isotropic_elements, mapping, ngllz, ngllx, materials,
      has_gll_model, h_property_index_mapping);

  elastic_anisotropic = specfem::medium::properties_container<
      specfem::element::medium_tag::elastic,
      specfem::element::property_tag::anisotropic>(
      elastic_anisotropic_elements, mapping, ngllz, ngllx, materials,
      has_gll_model, h_property_index_mapping);
