 ...
 *
 *
 * By default, a table will be formatted as below:
 *
 *     column 0 | column 1 | ... |
 *     --------------------------
 *     row1data | row1data | ... |
 *     row2data | row2data | ... |
 *
 * With each column representing some labeled property that has a data type.
 */
class Table {
public:
...
// StreamType &operator<<(StreamType &stream, const specfem::test::Table &table)
// {
//   stream << 1;
//   return stream;
// }
